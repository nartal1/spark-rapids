...
2026-05-02. The source-of-truth implementation record is now
...
Deferred items remain: native cuDF/Base2 DV reader support, DV predicate
pushdown, split/native optimized DV scanning, true DV-aware coalescing, CDC + DV
reads, and DB-17.3 CI enablement.
