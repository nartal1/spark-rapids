...
- **DV write handling**
  ...
  - The DBR-17.3 Issue 3 DELETE/UPDATE branch is PR-ready at
    `c8a0f87b86c16ce02097ae3501c328f584bb720e` for non-persistent-DV rewrites
    and keeps persistent-DV write paths on CPU.
...
- CI enablement for all Delta tests remains a later step after the remaining Delta
  follow-ups are validated. Issue 3 is PR-ready locally on the DELETE/UPDATE branch
  at `c8a0f87b86c16ce02097ae3501c328f584bb720e`, and Issue 6 is implemented in the
  native-DV branch.
