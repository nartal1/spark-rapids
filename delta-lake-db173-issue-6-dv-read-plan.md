...
DV reader landed on 2026-05-02; the native cuDF DV follow-up landed locally on
2026-05-05.
...
2026-05-05 follow-up described below. CDC + DV reads and Issue 7 CI enablement
remain open.
...
- Native scanning requires DBR metadata-row-index mode plus the RAPIDS DV
  predicate-pushdown config. Otherwise DBR-17.3 uses the materialized Scala/GPU
  DV reader.
...
2026-05-05 follow-up adds the DBR-17.3 native cuDF path for the supported read cases.
...
- Historical 2026-05-02 non-goal now delivered locally on 2026-05-05:
  V2/Base2-equivalent cuDF-native DV reader path for supported DBR-17.3 reads.
