...
`RapidsDeletionVectors`, and `RapidsRowIndexFilters`. Native cuDF DV reading,
predicate pushdown, split/native optimized scanning, true DV-aware coalescing,
and CDC + DV reads remain follow-up work.
