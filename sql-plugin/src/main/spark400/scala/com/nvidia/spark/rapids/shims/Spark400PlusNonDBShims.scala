...
// import com.nvidia.spark.rapids.shims.Spark340PlusNonDBShims

// import org.apache.spark.sql.catalyst.expressions.{Expression, SortOrder}
import org.apache.spark.sql.execution.adaptive.{AdaptiveSparkPlanExec, BroadcastQueryStageExec, ShuffleQueryStageExec, ResultQueryStageExec}
import org.apache.spark.sql.execution.{CommandResultExec, SparkPlan}

trait Spark400PlusNonDBShims extends Spark340PlusNonDBShims {

   override def findOperators(plan: SparkPlan, predicate: SparkPlan => Boolean): Seq[SparkPlan] = {
    println(s"findOperators from Spark400PlusNonDBShims: ${plan.toString}")
    def recurse(
        plan: SparkPlan,
