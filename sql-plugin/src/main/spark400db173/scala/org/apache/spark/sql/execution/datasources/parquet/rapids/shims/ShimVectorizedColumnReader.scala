...
/**
 * Identity mapping implementation for ParquetIdExternalMapping
 */
object IdentityParquetIdMapping extends ParquetIdExternalMapping {
  override def fromExternal(externalId: Int): Option[Int] = Some(externalId)
  override def toExternal(internalId: Int): Option[Int] = Some(internalId)
}
