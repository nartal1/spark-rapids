...
object SparkShimServiceProvider {
  ...
  val VERSION = DatabricksShimVersion(4, 1, 0, "18.3")
}
...
class SparkShimServiceProvider extends com.nvidia.spark.rapids.SparkShimServiceProvider {
  ...
  def matchesVersion(version: String): Boolean = {
    val shimEnabledProp = "spark.rapids.shims.spark410db183" + ".enabled"
    ...
    DatabricksShimServiceProvider.matchesVersion(
      ...
      disclaimer = "Development of support for Databricks 18.3.x is still in progress"
    )
  }
}
