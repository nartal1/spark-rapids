...
import org.apache.spark.sql.rapids.shims.TrampolineUtilsShims.StrategyShims
...
trait DeltaProvider {
  ...
  def getStrategyRules: Seq[StrategyShims]
...
object NoDeltaProvider extends DeltaProvider {
  ...
  override def getStrategyRules: Seq[StrategyShims] = Nil
