...
DML (DELETE/UPDATE/MERGE), OPTIMIZE, CDC + DV reads, and CI enablement remain
follow-up work. The 2026-05-14 guard keeps DBR DML/DELETE fallback plans from
losing their DB skip-row predicate and adds a Python canary for DB's missing
