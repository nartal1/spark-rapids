...
**Status (updated 2026-05-20):** Implemented locally on
`delta_db173_OPTIMIZE_AUTO_COMPACT` and split into a clean review stack.
Regular OPTIMIZE + auto-compaction should be reviewed separately from liquid
clustering.
...
- PR 1: include through `9ae539a3b` for DBR 17.3 regular OPTIMIZE and
  auto-compaction.
